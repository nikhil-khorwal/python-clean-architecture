...
from app.ecommerce.order.use_cases.get_order_by_id_use_case import get_order_by_id_use_case
...
class TestOrderUseCaseGetOrderById(TestCase):
    def setUp(self):
    ...
    def test_get_order_by_id_with_invalid_request(self):
    ...
    def test_get_order_by_id_with_valid_request(self):
        with current_app.test_request_context("/?user_email={}".format(self.user["email"])):
