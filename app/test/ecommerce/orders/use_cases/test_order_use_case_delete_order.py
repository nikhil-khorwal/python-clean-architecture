...
from app.ecommerce.order.use_cases.delete_order_use_case import delete_order_use_case
...
class TestOrderUseCaseDeleteOrder(TestCase):
    def setUp(self):
    ...
    def test_delete_order_with_invalid_request(self):
    ...
    def test_delete_order_with_valid_request(self):
        with current_app.test_request_context("/?user_email={}".format(self.user["email"])):
